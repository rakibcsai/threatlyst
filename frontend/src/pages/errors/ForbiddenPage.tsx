...
export function ForbiddenPage() {
  return (
    <main className="grid min-h-[calc(100vh-4rem)] place-items-center p-6 text-center">
      <div>
        <ShieldX className="mx-auto size-10 text-amber-400" />
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-500">
          Your session is still active. Contact a ThreatLyst administrator if
          your responsibilities require additional access.
        </p>
        <Link
          to="/dashboard"
