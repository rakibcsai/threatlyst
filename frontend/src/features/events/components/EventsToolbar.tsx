    ...
    <div className="flex flex-col gap-3 border-b border-slate-800/80 p-4 lg:flex-row lg:items-center">
      <label className="relative min-w-0 flex-1">
        ...
        <input
          ...
          placeholder="Search ID, source, IP, user, host, or message"
        />
      </label>
